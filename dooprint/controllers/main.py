...
class DooprintController(http.Controller):
    ...
    @http.route('/dooprint/register', type='json', auth='public', csrf=False, save_session=False)
    ...
    @http.route('/dooprint/heartbeat', type='json', auth='public', csrf=False, save_session=False)
    ...
    @http.route('/dooprint/jobs', type='json', auth='public', csrf=False, save_session=False)
    ...
    @http.route('/dooprint/ack', type='json', auth='public', csrf=False, save_session=False)
